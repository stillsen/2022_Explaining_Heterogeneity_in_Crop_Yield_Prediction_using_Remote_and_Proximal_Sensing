...
if __name__ == "__main__":
    ...
    this_output_dir = output_dirs[patch_no]+'_'+architecture+'_'+validation_strategy+'_TL-Finetune_L1_ALB_TR'+str(repeat_trainset_ntimes)+'_E'+str(num_epochs)
    ...
    for k in range(num_folds):
        ...
        tune_name = 'Tuning_{}_{}_all_bayes_L1_ALB_f{}_{}_TR{}'.format(architecture, validation_strategy, k, patch_no,
                                                                       repeat_trainset_ntimes)
        ...
        model_wrapper.set_optimizer( lr=lr/10,
                                     momentum=momentum,
                                     wd=wd,
                                     )
        ...
        df = pd.DataFrame({'train_loss': train_loss,
                           ...
                           'time': run_time,
                           # 'ft_val_loss':model_wrapper.test_mse_history,
                           # 'ft_train_loss':model_wrapper.train_mse_history,
                           # 'ft_best_epoch':model_wrapper.best_epoch,
                           })

...
# this_output_dir = '/beegfs/stiller/PatchCROP_all/Output/L2/SSL/Combined_crops_train_VICReg_SCV_no_test_E1000lightly-VICReg_kernel_size_56/'
...
for s in sets:
    ...
    for k in range(num_folds):
        ...
        dataloaders_dict = {'train': datamodule.train_dataloader(shuffle=False), 'val': datamodule.val_dataloader(shuffle=False),

...
this_output_dir = output_dirs[patch_no] + '_' + architecture + '_' + validation_strategy + '_E' + str(num_epochs) + 'lightly-VICRegL_kernel_size_' + str(kernel_size)+'-black-added-to-train-and-val'
...
models.train_and_tune_lightlySSL(start=0, SSL_type = architecture, domain_training_enabled=True)
...
if __name__ == "__main__":
    ...
    # this_output_dir = output_dirs[patch_no]+'_'+architecture+'_'+validation_strategy+'_TL'+'_E'+str(num_epochs)
    # this_output_dir = output_dirs[patch_no]+'_'+architecture+'_'+validation_strategy+'_L2'+'_E'+str(num_epochs)
    this_output_dir = output_dirs[patch_no] + '_' + architecture + '_' + validation_strategy + '_NoLap' + '_E' + str(num_epochs)

...
if __name__ == "__main__":
    ...
    # this_output_dir = output_dirs[patch_no]+'_'+architecture+'_'+validation_strategy+'_SSL_ALB'+'_E2000_resetW'
    ...
    for k in range(3,num_folds):
        ...
        for strategy in training_strategy:
            ...
            # if not(k==1 and strategy=='self-supervised'):
            ...
            # training_strategy_params[strategy]['lr'] = 0.001
            # training_strategy_params[strategy]['wd'] = 0.0005
            # training_strategy_params[strategy]['batch_size'] = 64
            # else:
            #     training_strategy_params[strategy]['lr'] = 0.001
            #     training_strategy_params[strategy]['wd'] = 0.0005
            #     training_strategy_params[strategy]['batch_size'] = 64

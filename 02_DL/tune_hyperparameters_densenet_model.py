...
class TuneYieldRegressor(tune.Trainable):
    def setup(self, config):
        ...
        output_dirs[73] = os.path.join(output_root, 'Patch_ID_73_RGB_densenet_augmented_fakelabels_tunedhyperparams_all')
...
if __name__ == "__main__":
    ...
    analysis = tune.run(TuneYieldRegressor,
                        ...
                        scheduler=hyperband,
                        resume="AUTO",
                        name='TuneYieldRegressor_densenet_clr_wd_bs',
                        )
    ...
    # output_dir = '/beegfs/stiller/PatchCROP_all/Output/Patch_ID_73_RGB_densenet_augmented_fakelabels_tunedhyperparams_1'

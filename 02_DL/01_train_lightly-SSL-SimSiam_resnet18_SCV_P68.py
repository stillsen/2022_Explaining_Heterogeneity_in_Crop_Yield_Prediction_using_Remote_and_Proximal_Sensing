...
SSL_transforms = SimSiamTransform(input_size=224,
                                 hf_prob=0.5,
                                 vf_prob=0.5,
                                 rr_prob=0.5,
                                 min_scale=0.5,
...
this_output_dir = output_dirs[patch_no] + '_' + architecture + '_' + validation_strategy + '_E' + str(num_epochs) + 'lightly-SimSiam_s30s30'
...
models.train_and_tune_lightlySSL(start=3, SSL_type = architecture)
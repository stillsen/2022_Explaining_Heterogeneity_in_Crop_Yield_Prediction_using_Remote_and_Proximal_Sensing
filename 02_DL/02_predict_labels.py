...
if __name__ == "__main__":
    ...
    ## Patch 73
    # output_dirs[73] = os.path.join(output_root, 'Patch_ID_73_RGB_densenet_not_augmented_custom_btf_art_labels_green_wd0_b200')
    output_dirs[73] = os.path.join(output_root,
                                   'Patch_ID_73_RGB_densenet_not_augmented_custom_btf_art_labels_green')
    ...
    datamodule = PatchCROPDataModule(input_files=input_files_rgb[patch_no], patch_id=patch_no, data_dir=data_dirs[patch_no], stride=stride, workers=os.cpu_count(), augmented=augmentation, input_features=features, batch_size=1)
    ...
    for s in sets:
        ...
        for k in range(num_folds):
            ...
            for inputs, labels in dl:
                ...
                # if s == 'train' and i<=20:
                #     print('{}. {} - {}'.format(i, labels.detach().cpu().numpy(), y_hat.detach().cpu().numpy()))
                #     i+=1
                # else:
                #     print('other')

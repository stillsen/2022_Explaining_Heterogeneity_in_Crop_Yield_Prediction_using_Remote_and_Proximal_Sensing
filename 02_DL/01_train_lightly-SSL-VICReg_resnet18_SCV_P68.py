...
SSL_transforms = VICRegTransform(input_size=224,
                                 hf_prob=0.5,
                                 vf_prob=0.5,
                                 rr_prob=0.5,
                                 min_scale=0.5,
...
this_output_dir = output_dirs[patch_no] + '_' + architecture + '_' + validation_strategy + '_E' + str(num_epochs) + 'lightly-VICReg_s30s75_ks' + str(kernel_size)
...
models.train_and_tune_lightlySSL(start=0, SSL_type = architecture)